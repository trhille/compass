...
from compass.landice.tests.time_convergence.conv_init import ConvInit
...
class Init(ConvInit):
    ...
    def __init__(self, test_case, dt):
        ...
        """
        super().__init__(test_case=test_case, dt=dt)
    ...
    def run(self):
        ...
        passiveTracer2d = numpy.exp(-0.5 * dist_sq / gaussian_width**2)
        passiveTracer2d = passiveTracer2d.expand_dims(dim='Time', axis=0)
        ...
        ds['passiveTracer2d'] = passiveTracer2d
